...
<pre style="position: relative;"><strong>Input:</strong> s = "iiii", k = 1
...
<pre style="position: relative;"><strong>Input:</strong> s = "leetcode", k = 2
...
<pre style="position: relative;"><strong>Input:</strong> s = "zbax", k = 2
